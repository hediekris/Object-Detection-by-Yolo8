...
def main():
    ...
    print(" WAL mode active |  dashboard can read live data now.")
    ...
    while True:
        ...
        if results[0].boxes.id is not None:
            ...
            for box, cls_id, trk_id in zip(boxes, cls_ids, trk_ids):
                ...
                prev_y = prev_centers.get(trk_id, cy)
                if trk_id not in crossed_ids and prev_y < line_y <= cy:
